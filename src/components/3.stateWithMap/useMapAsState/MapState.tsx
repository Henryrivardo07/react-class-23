  ...
  return (
    <div className={styles.container}>
      <div>
        ...
        <Button
          variant='secondary'
          onClick={() => handleAddOrUpdateUser('Henry', 'henry@example.com')}
        >
          PESAN 1
        </Button>
        <Button
      ...
      <div>
        ...
        <Button variant='danger' onClick={() => handleDeleteUser('Rivardo')}>
          Delete Rivardo
        </Button>
        <Button variant='danger' onClick={() => handleDeleteUser('Windah')}>
          Delete Windah
        </Button>
      </div>
